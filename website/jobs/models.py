...
class Job(models.Model):
    ...
    work_type = models.CharField('What type of an opening suits you ?', max_length=10, choices=WORK_TYPES)
    age = models.CharField('What age you are bud ?', max_length=20, choices=AGE, null=True, blank=True)
