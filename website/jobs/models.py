...
EXP = (('kiddo', 'Kiddo'), ('teen', 'Teenager'), ('legal', 'Legal'), ('mid-life crisis', 'Mid-Life Crisis'), ('boomer', 'Boomer'))
STATUS = (('applied', 'Applied'), ('shortlisted', 'Shorlisted'), ('accepted', 'Accepted'), ('rejected', 'Rejected'))
...
class Job(models.Model):
    ...
    work_type = models.CharField('What opening suits you ?', max_length=10, choices=WORK_TYPES)
    age = models.CharField('What age you are bud ?', max_length=20, choices=EXP, null=True, blank=True)
